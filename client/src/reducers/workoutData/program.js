export default function() {
  return {
    ...
    liftType(day) {
      if (day === 1 || day % 4 === 1) {
        this.workoutType = "Bench";
      } else if (day === 2 || day % 16 === 2) {
        this.workoutType = "Squats";
      } else if (day === 3 || day % 4 === 3) {
        this.workoutType = "Deadlift";
      } else if (day === 4 || day % 4 === 0) {
        this.workoutType = "Military Press";
      }
    ...
    ckWave(day) {
      if (day <= 16) {
        this.wave = 10;
        return this.wave;
      } else if (day > 16 && day <= 32) {
        this.wave = 8;
        return this.wave;
      } else if (day > 32 && day <= 48) {
        this.wave = 5;
        return this.wave;
      } else if (day > 48 && day <= 64) {
        this.wave = 3;
        return this.wave;
      }
    },
